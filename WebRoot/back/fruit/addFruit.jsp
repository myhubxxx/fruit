			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					<li><a href="index.html"><i
							class="fa fa-dashboard fa-fw nav_icon"></i>后台主页</a>
					</li>
					...
					<li><a href="#"><i class="fa fa-envelope nav_icon"></i>订单管理<span
							class="fa arrow"></span> </a>
						<ul class="nav nav-second-level">
							<li><a href="inbox.html">查看订单</a>
							</li>
							<li><a href="compose.html">订单分析</a>
							</li>

						</ul> <!-- /.nav-second-level -->
					</li>
					<li><a href="widgets.html"><i class="fa fa-flask nav_icon"></i>预留</a>
					</li>
					<li><a href="#"><i class="fa fa-check-square-o nav_icon"></i>预留二<span
							class="fa arrow"></span> </a>
						<ul class="nav nav-second-level">
							<li><a href="forms.html">未分配</a>
							</li>
							<li><a href="validation.html">未分配二</a>
							</li>
						</ul> <!-- /.nav-second-level -->
					</li>
				...
				<div class="xs">
					...
					<div class="inbox_right">
						<div class="Compose-Message">
							...
							<s:form action="file_saveFruitImg" method="post" enctype="multipart/form-data">
											<!-- fruit%{fid==null?'addFruit':'editFruit'}.action -->
								<div class="panel-heading"><s:property value="%{fid==null?'添加':'修改'}"/>水果</div>
								<div class="panel-body">
									<div class="alert alert-info">完整填入每一项新上线一种水果</div>
									<hr>
									<label>名称 : </label> 
									<input type="text" name="fname" class="form-control1 control3"></input> 
									<label>单价 : </label> 
									<input type="text" name="fprice" class="form-control1 control3"></input>
									<label>库存: </label> 
									</label> <input type="text" name="famount" class="form-control1 control3"></input>
									<label>合作商家 : </label> 
									</label> <input type="text" name="place" class="form-control1 control3"></input> 
									<label>图片: </label> 
